...
//   let restaurantclass = document.querySelector(".restaurants")
...
//     });
//     // restaurantsBoxes.classList.add(".box");
...
//       box.style.float = "";
//     });
//     // restaurantsBoxes.classList.remove(".box");
    ...
    if (isChecked) {
      ...
      //If restaurents selected
        ...
        if (!isRest) {
          ...
          //restaurents - > breakfast - > budget-friendly
          else if (bf.checked) {
            if (!isBf) {
              restaurant.style.display = "none";
            }
          }
          //restaurents - > breakfast - > mid-range
          else if (mr.checked) {
            if (!isMr) {
              restaurant.style.display = "none";
            }
          }
          //restaurents - > breakfast - > upscale
          else if (us.checked) {
            if (!isUs) {
              restaurant.style.display = "none";
            }
      ...
      } else if (vegres.checked && rest.checked && breakfast.checked) {
        if (!isVeg && !isRest && !isBreakfast) {
          restaurant.style.display = "none";
        }
      }
      ///////////
